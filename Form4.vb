...
Public Class Form4
    ...
    Private Sub DataGridView1_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        Else
            TXTJDATE.Text = ""
        End If
        If Not IsDBNull(DataGridView1.CurrentRow.Cells(7).Value) Then
            TextBox1.Text = DataGridView1.CurrentRow.Cells(7).Value
        Else
            TextBox1.Text = ""
        End If
        If Not IsDBNull(DataGridView1.CurrentRow.Cells(8).Value) Then
    ...
    Private Sub CMDBOOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CMDBOOK.Click
        ...
        XX.txtpnr.Text = Me.TextBox1.Text
        XX.txtfare.Text = Me.TextBox2.Text
    ...
    Private Sub TXTFLTNO_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TXTFLTNO.TextChanged
